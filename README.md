...
1. Fork this repository using the button in the upper right of the GitHub page. This will create a copy of the repository in your own GitHub profile, giving you full control over your copy.
...
2. Clone the repository to your local machine from your forked version.
   ...
   ```
   This will create a remote `origin` to your forked version (not the NOAA-CEFI-Portal version).
...
1. Create a remote `upstream` to track the changes that are on NOAA-CEFI-Portal.
...
3. Merge the updated local `main` branch into your local `<feature-branch-name>` branch to keep it up to date.
