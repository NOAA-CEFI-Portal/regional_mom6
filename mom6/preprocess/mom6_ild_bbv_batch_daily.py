...
def ild_bbv_batch(dict_json:dict, n=0):
    ...
    thetao_path = local_access.get(variable='thetao')[n]
    so_path = local_access.get(variable='so')[n]
    ...
    ds_tos=ds_tos.sel(time=ds_so.time)
    # calculate the BBV
