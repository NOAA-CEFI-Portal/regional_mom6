...
def regrid_batch(dict_json:dict,sub_dir):
    ...
    output_dir = os.path.join(local_top_dir,output_cefi_rel_path,sub_dir)
    ...
    try:
       # Load the settings
        ...
        try: 
            ...
            sub_dirs = dict_json1['sub_dirs']
            for sub_dir in sub_dirs:
                regrid_batch(dict_json1,sub_dir)
